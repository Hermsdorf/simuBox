...
void window::make_GUI_layer()
{
    ...
    int y1 = SCREEN_HEIGHT - (SCREEN_HEIGHT / 5) - 50;
    ...
    GUI().newElement(LINE_DRAW,x0,y1, SCREEN_WIDTH, y1, {255, 255, 255});

    GUI().newTextElement(500 , 10, 32, 15, {168,168,168} , "click to play!",1);
    GUI().newTextElement(500 , 30, 32, 15, {168,168,168} , "R: reset",1);
...
{
    workbench().newElement(type,x - w, y - h, w, h, c);
}
